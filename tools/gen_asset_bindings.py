...
asset_lines.append("typedef struct { void* sym; unsigned char segment; unsigned int rom_base; unsigned char compressed; unsigned int offset; unsigned int image_size; const char* o2r_key; } GdxAssetSegmentEntry;")
...
for sym, segment, rom_base, compressed, offset, image_key, yaml_stem in asset_segment_entries:
    ...
    asset_lines.append("    {{ {}, 0x{:02X}u, 0x{:08X}U, {}u, 0x{:08X}U, 0x{:08X}U, \"{}\" }},".format(
        sym, segment, rom_base, compressed, offset, image_size, o2r_key))
